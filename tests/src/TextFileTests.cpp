...
void TextFileTests::ReadLineTest1(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NOT(error);
    ISHIKO_TEST_ABORT_IF_NEQ(error.code(), FileSystemErrorCategory::Value::read_error);
...
void TextFileTests::ReadLineTest2(Test& test)
{
    ...
    ISHIKO_TEST_FAIL_IF_NOT(error);
    ISHIKO_TEST_ABORT_IF_NEQ(error.code(), FileSystemErrorCategory::Value::end_of_file);
    ISHIKO_TEST_FAIL_IF_NEQ(line, "");
    ISHIKO_TEST_PASS();
}
